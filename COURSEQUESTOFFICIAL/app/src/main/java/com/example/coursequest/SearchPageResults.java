...
public class SearchPageResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String searched = getIntent().getStringExtra("SEARCHED");

        ArrayList<Course> courses = search(searched);
    ...
    public ArrayList<Course> search(String searchFor)
    {
        ...
        SkillShareScraper scrape1 = new SkillShareScraper();
        results = scrape1.getCourses(searchFor);
        return results;
    }
    ...
    public void displayResults(ArrayList<Course> courses, ArrayList<Button> buttons)
    {
        ...
        for (int i = 0; i<courses.size(); i++)
        {
            ...
            if (courseView != null)
            {
                final String courseLink = currentCourse.getCourseLink();
