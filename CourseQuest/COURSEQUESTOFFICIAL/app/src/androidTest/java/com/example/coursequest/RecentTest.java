/*
Scenario:
- Given a user who has recently searched "Java", that user will be able to see this search in
  their history and continue their search at a later date with ease
 */
