/*
Scenario:
- Given a user who decides to not want to share a course after clicking share, the user will be
  able to click cancel, so that they can return to browsing courses.
 */
...
public class ShareButtonCancelTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void shareButtonCancelTest() {
